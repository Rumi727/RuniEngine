...
그렇기에 [Visual Studio]에서 [nullable 참조 형식]을 사용할 수 있게 해주는 [패키지](https://github.com/Rumi727/Unity-Nullable-Enabler)를 설치하는 것을 강력 추천합니다
...
4. 패키지 관리자에서 git URL로 설치합니다 (* 표시된건 필수 패키지이며 꼭 순서대로 설치해야합니다)
