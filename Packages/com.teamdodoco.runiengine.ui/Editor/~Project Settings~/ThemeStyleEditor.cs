...
namespace RuniEngine.Editor.ProjectSettings
{
    public class ThemeStyleEditor : IThemeStyleEditor
    {
        ...
        public bool DrawGUI(ThemeStyle style)
        {
            bool changed = false;
        ...
        public static NameSpaceIndexTypeNamePair NameSpaceIndexTypeNamePairField(NameSpaceIndexTypeNamePair value)
        {
            value.nameSpace = DrawNameSpace(TryGetText("gui.namespace"), value.nameSpace);
            value.type = DrawStringArray(TryGetText("gui.type"), value.type, ImageLoader.GetTypes(value.nameSpace));
            value.name = DrawStringArray(TryGetText("gui.name"), value.name, ImageLoader.GetSpriteNames(value.type, value.nameSpace));
