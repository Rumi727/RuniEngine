	...
	LOD 100
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				#endif
				float4 lerpResult3 = lerp( _bottom , _top , pow( saturate( ( staticSwitch13 * _mult ) ) , _power ));
...
Node;AmplifyShaderEditor.RangedFloatNode;10;-468.1788,419.5748;Inherit;False;Property;_power;pwer;3;0;Create;True;0;0;False;0;1;0.11;0;0;0;1;FLOAT;0
